...
class UtilTests(unittest.TestCase):
    ...
    def test_strip_punctuation(self):
        ...
        text = "\"Quote"
        self.assertEqual("Quote", util._strip_straight_quotes(text))

    def test_strip_balanced_punctuation(self):
        """Don't modify balanced quotation marks"""
        text = "\"Quote\""
        self.assertEqual(text, util._strip_straight_quotes(text))
    ...
    def test_strip_backwards_quotes(self):
        ...
        text = ".\" She said, \""
        self.assertEqual(". She said, ", util._strip_straight_quotes(text))
    ...
    def test_strip_interleaved_parentheses(self):
        ...
        self.assertEqual("It's true (but (it) might not be)",
                         util._strip_parens(text))

    def test_curly_quotes(self):
        """Correctly strip curly quotes"""
        text = "“foo”"
        self.assertEqual("“foo”", util._strip_curly_quotes(text))
